...
import { Film, Users, CheckCircle2, ShieldCheck, Video, Clock } from 'lucide-react';

export const MediaHeroChart: React.FC = () => {
  return (
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <h4 className="font-extrabold text-[14px] sm:text-[15px] leading-[18px] text-slate-900 truncate sm:whitespace-normal">
              Media Production & Mixed Staff
            </h4>
            <p className="font-['Inter',sans-serif] text-[11px] sm:text-[11.5px] text-slate-500 font-medium truncate sm:whitespace-normal">
              Full-time, part-time & freelance tracking
            </p>
          </div>
        </div>
        <div className="flex items-center gap-1.5 bg-rose-50 border border-rose-200/60 px-2.5 sm:px-3 py-1 rounded-full text-rose-700 font-bold text-[10.5px] sm:text-[11px] shrink-0">
          <span className="w-2 h-2 rounded-full bg-rose-500 animate-pulse" />
          <span>Air Date Ready</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 z-10">
        ...
        >
          ...
          <div className="flex items-baseline justify-between pt-0.5 gap-1">
            <span className="text-[18px] sm:text-[20px] font-black text-slate-900">48 Staff</span>
            <span className="text-[10px] font-bold text-indigo-700 bg-indigo-50 px-1.5 py-0.5 rounded shrink-0">FT / PT / Contract</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-baseline justify-between pt-0.5 gap-1">
            <span className="text-[18px] sm:text-[20px] font-black text-slate-900">6 Approved</span>
            <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded shrink-0">Routed</span>
          </div>
        </motion.div>
      </div>

      {/* Main Grid: Production Roster & Content Sign-off Feeds */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 z-10 flex-1 my-1">
        {/* Left Column: Production Roster */}
        <div className="bg-white/90 backdrop-blur-md rounded-[18px] border border-slate-200/70 p-3.5 flex flex-col justify-between shadow-xs">
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 gap-2">
            <span className="text-[12px] font-bold text-slate-800 flex items-center gap-1.5 shrink-0">
              <Users size={13} className="text-[#5C5CFF]" />
              Production Roster
            </span>
            <span className="text-[10px] font-semibold text-slate-400 shrink-0">Mixed Staff</span>
          </div>
          ...
          <div className="flex flex-col gap-2 pt-1.5">
            ...
            <div className="flex items-center justify-between p-2 rounded-xl bg-indigo-50/70 border border-indigo-100 gap-2">
              <div className="min-w-0">
                <div className="text-[11.5px] font-bold text-indigo-950 truncate">Sarah K.</div>
                <div className="text-[10px] text-indigo-600 font-medium truncate">Full-Time Editorial Lead</div>
              </div>
              <span className="bg-[#5C5CFF] text-white text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0">Full-Time</span>
            </div>

            {/* Staff 2 */}
            <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 border border-slate-200/50 gap-2">
              <div className="min-w-0">
                <div className="text-[11.5px] font-bold text-slate-900 truncate">Marcus V.</div>
                <div className="text-[10px] text-slate-500 font-medium truncate">Contract Video Editor</div>
              </div>
              <span className="bg-rose-100 text-rose-800 text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0">Contract</span>
            </div>

            {/* Staff 3 */}
            <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 border border-slate-200/50 gap-2">
              <div className="min-w-0">
                <div className="text-[11.5px] font-bold text-slate-900 truncate">Elena R.</div>
                <div className="text-[10px] text-slate-500 font-medium truncate">Part-Time Graphic Artist</div>
              </div>
              <span className="bg-emerald-100 text-emerald-800 text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0">Part-Time</span>
            </div>
          </div>
        </div>

        {/* Right Column: Content Sign-off Feeds */}
        <div className="bg-white/90 backdrop-blur-md rounded-[18px] border border-slate-200/70 p-3.5 flex flex-col justify-between shadow-xs">
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 gap-2">
            <span className="text-[12px] font-bold text-slate-800 flex items-center gap-1.5 shrink-0">
            ...
            <span className="text-[10px] font-semibold text-emerald-600 shrink-0">Air Date</span>
          </div>
          ...
          <div className="flex flex-col gap-2 pt-1.5">
            ...
            <div className="flex items-center justify-between text-[11px] gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="font-bold text-slate-900 truncate">Docu Ep 4 Cut</div>
                  <div className="text-[9.5px] text-slate-400 truncate">Director Sign-Off</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between text-[11px] gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="font-bold text-slate-900 truncate">Podcast Audio Master</div>
                  <div className="text-[9.5px] text-slate-400 truncate">In Review</div>
                </div>
              </div>
              <span className="text-[10px] font-bold text-rose-600 bg-rose-50 px-1.5 py-0.5 rounded shrink-0">In Review</span>
            </div>
            ...
            <div className="flex items-center justify-between text-[11px] gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="font-bold text-slate-900 truncate">Magazine Cover</div>
                  <div className="text-[9.5px] text-slate-400 truncate">Sign-Off Pending</div>
                </div>
              </div>
              <span className="text-[10px] font-bold text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded shrink-0">Pending</span>
            </div>
          </div>
        </div>
      </div>
