...
export const Education2Page: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-['Plus_Jakarta_Sans',sans-serif]">
      {/* 1. HERO SECTION */}
      <section className="relative pt-[120px] pb-24 sm:pb-32 bg-[#0A0F1C] border-b border-slate-100 min-h-[900px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#0A0F1C]/80 via-transparent to-[#0A0F1C]" />
        </div>

        <Container className="relative z-10 max-w-[1280px] px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          {/* Hero Header Content */}
          <div className="flex flex-col items-center text-center max-w-[920px] mx-auto mb-16">
            <h1 className="font-['Plus_Jakarta_Sans'] font-bold text-[40px] sm:text-[52px] lg:text-[60px] leading-[1.1] tracking-[-1px] text-white max-w-[800px] mb-6 drop-shadow-md">
              Attendance Management Built for Modern Campuses
            </h1>

            <p className="font-['Inter'] font-medium text-[16px] sm:text-[18px] leading-[28px] text-white/90 max-w-[640px] mb-8 drop-shadow-sm">
            ...
            <div className="flex justify-center items-center">
              <a
                ...
                onClick={scrollToTop}
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#111827] font-['Inter'] font-bold text-[16px] rounded-full transition-all duration-300 hover:scale-105 hover:bg-gray-100 shadow-xl"
              >
                Book Demo
              </a>
            </div>
          ...
          {/* Hero Dashboard Card Overlay */}
          <div className="relative w-full max-w-[800px] mt-4 mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
            
            {/* Floating Left Tag */}
            <div className="absolute -left-[10%] sm:-left-[80px] top-[40px] bg-white rounded-xl shadow-lg border border-gray-100 p-3.5 pr-6 flex items-center gap-3 z-20 animate-bounce" style={{ animationDuration: '3s' }}>
              <div className="w-8 h-8 rounded-full bg-emerald-50 flex items-center justify-center shrink-0">
                <Check className="w-5 h-5 text-emerald-500" strokeWidth={3} />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-[16px] text-gray-900 leading-tight">324</span>
                <span className="font-medium text-[12px] text-gray-500 leading-tight">Present Students</span>
              </div>
            </div>

            {/* Floating Right Tag */}
            <div className="absolute -right-[10%] sm:-right-[80px] bottom-[40px] bg-white rounded-xl shadow-lg border border-gray-100 p-3.5 pr-6 flex items-center gap-3 z-20 animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
              <div className="w-8 h-8 rounded-full bg-indigo-50 flex items-center justify-center shrink-0">
                <Clock className="w-5 h-5 text-[#5C5CFF]" strokeWidth={2.5} />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-[16px] text-gray-900 leading-tight">38</span>
                <span className="font-medium text-[12px] text-gray-500 leading-tight">Faculty Available</span>
              </div>
            </div>

            {/* Main Card */}
            <div className="bg-white/95 backdrop-blur-xl rounded-[24px] shadow-2xl border border-white/20 p-6 sm:p-8 relative z-10 w-full overflow-hidden">
              {/* Header */}
              <div className="flex justify-center items-center gap-2 mb-8 border-b border-gray-100 pb-4">
                <div className="w-6 h-6 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-xs">Z</div>
                <span className="font-semibold text-gray-500 text-sm tracking-wide">Admin Dashboard — Workzi Education</span>
              </div>

              {/* Metrics */}
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm flex flex-col items-start justify-center">
                  <span className="font-bold text-[28px] sm:text-[36px] text-gray-900 leading-none mb-1">96%</span>
                  <span className="font-semibold text-[10px] sm:text-[12px] text-gray-400 uppercase tracking-wider">ATTENDANCE</span>
                </div>
                <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm flex flex-col items-start justify-center">
                  <span className="font-bold text-[28px] sm:text-[36px] text-gray-900 leading-none mb-1">42</span>
                  <span className="font-semibold text-[10px] sm:text-[12px] text-gray-400 uppercase tracking-wider">CLASSES TODAY</span>
                </div>
                <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm flex flex-col items-start justify-center">
                  <span className="font-bold text-[28px] sm:text-[36px] text-gray-900 leading-none mb-1">1,284</span>
                  <span className="font-semibold text-[10px] sm:text-[12px] text-gray-400 uppercase tracking-wider">PRESENT</span>
                </div>
              </div>

              {/* Bar Chart Mockup */}
              <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm h-[140px] flex items-end justify-between gap-2 sm:gap-4 px-4 sm:px-8 pt-10 relative">
                 <div className="absolute top-4 left-4 font-semibold text-xs text-gray-400 uppercase tracking-wider">Weekly Overview</div>
                 <div className="w-full h-[40%] bg-[#6B6EFE] rounded-t-md hover:bg-[#5C5CFF] transition-colors cursor-pointer" />
                 <div className="w-full h-[70%] bg-[#6B6EFE] rounded-t-md hover:bg-[#5C5CFF] transition-colors cursor-pointer" />
                 <div className="w-full h-[55%] bg-[#6B6EFE] rounded-t-md hover:bg-[#5C5CFF] transition-colors cursor-pointer" />
                 <div className="w-full h-[90%] bg-[#6B6EFE] rounded-t-md hover:bg-[#5C5CFF] transition-colors cursor-pointer" />
