...
export const PlatformCapabilities: React.FC = () => {
  const cards = [
    ...
    },
    {
      ...
      desc: 'Multi-type Time-off requests, configurable approval workflows, and real-time balance tracking for the entire team.',
      iconBg: 'bg-[rgba(16,185,129,0.1)]',
      icon: <Calendar className="w-6 h-6 text-[#10B981]" />,
    },
    {
      title: 'Employee Profiles',
      desc: 'Centralized employee directory with personal info, attendance records, and Time-off history in one place.',
      iconBg: 'bg-[rgba(245,158,11,0.1)]',
      icon: <User className="w-6 h-6 text-[#F59E0B]" />,
    },
    {
      title: 'Notifications',
      desc: 'Instant push notifications for Time-off approvals, check-in reminders, and important HR announcements.',
      iconBg: 'bg-[rgba(239,68,68,0.08)]',
      icon: <Bell className="w-6 h-6 text-[#EF4444]" />,
    },
    {
      title: 'Reports & Analytics',
      desc: 'Comprehensive attendance reports, Time-off summaries, and workforce trends — exportable as CSV or PDF.',
      iconBg: 'bg-[rgba(91,95,255,0.1)]',
