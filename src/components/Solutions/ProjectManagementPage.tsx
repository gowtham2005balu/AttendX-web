...
import { ProjectManagementHeroChart } from './ProjectManagementHeroChart';
...
/* ─── 1. HERO SECTION ─── */
const ProjectManagementHero: React.FC = () => (
  <div className="w-full bg-white pt-[68px]">
    ...
    <div className="w-full max-w-[1280px] mx-auto px-6 lg:px-0 h-[45px] py-[14px] flex items-center gap-[8px]">
      <div className="flex items-center gap-[8px] font-['Inter',sans-serif] text-[13px] leading-[16px] text-[#6B7280]">
        ...
        <span>/</span>
        <span className="font-semibold text-[#111827]">Project Management</span>
      </div>
    </div>
        ...
        <div className="flex flex-col items-start w-full lg:w-[578px] pt-[3px] gap-[16.8px] shrink-0">
          ...
          <div className="flex items-center w-full h-[16px]">
            <span className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[13px] leading-[16px] tracking-[0.65px] uppercase text-[#5C5CFF]">
              WORKZI — SOLUTIONS FOR PROJECT MANAGEMENT
            </span>
          </div>
...
const ProjectManagementProblemValue: React.FC = () => (
    ...
    <div className="w-full max-w-[1280px] mx-auto flex flex-col items-center gap-[52px]">
      ...
      <div className="flex flex-col items-center text-center gap-[13.2px] max-w-[950px] w-full">
        <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[28px] sm:text-[36px] lg:text-[40px] leading-[1.25] tracking-[-0.84px] text-[#111827] text-center max-w-[950px] w-full">
          <span className="inline-block">Task Tools Don't Know Who's Actually Available.</span>{' '}
          <span className="inline-block">Workzi Does.</span>
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-[24px] w-full max-w-[1216px]">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-[24px] p-[32px] flex flex-col justify-between gap-[11.4px] w-full">
          <div>
            <h3 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[20px] leading-[23px] tracking-[-0.4px] text-[#111827] mb-3">
              Comments & attachments in context
            </h3>
            <p className="font-['Inter',sans-serif] font-normal text-[14.5px] leading-[24px] text-[#6B7280] mb-6">
              Updates live directly with the task, not scattered across chat apps.
            </p>
          </div>
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-[24px] p-[32px] flex flex-col justify-between gap-[11.4px] w-full">
          <div>
            ...
            <p className="font-['Inter',sans-serif] font-normal text-[14.5px] leading-[24px] text-[#6B7280] mb-6">
              No manual chasing required to find out what slipped or stalled.
            </p>
          </div>
...
/* ─── 3. REASON BLOCKS ─── */
const ProjectManagementKnowledgeSections: React.FC = () => {
  return (
    <div className="w-full bg-white py-[40px]">
      ...
      <div className="w-full max-w-[1240px] mx-auto pt-[40px] pb-[20px] px-6 lg:px-[100px] flex flex-col items-center text-center gap-[13.2px]">
        <span className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[13px] leading-[16px] tracking-[0.65px] uppercase text-[#5C5CFF]">
          WHY TEAMS USE WORKZI FOR TASK MANAGEMENT
        </span>
        <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[32px] sm:text-[42px] leading-[40px] sm:leading-[46px] tracking-[-0.84px] text-[#111827] text-center max-w-[700px]">
          Everything a Task Needs, Without a Separate Tool
        </h2>
      </div>

      {/* Reason 1: Create, Assign & Prioritize */}
        ...
        <div className="w-full max-w-[1240px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-[50px]">
          <div className="flex flex-col items-start p-0 gap-6 mx-auto max-w-[589px] w-full h-auto justify-center self-center">
              ...
              <div className="flex flex-col items-start p-0 gap-5 w-full max-w-[549px] self-stretch">
                <div className="flex flex-col items-start p-0 gap-3 w-full max-w-[549px] self-stretch">
                  <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[36px] sm:text-[42px] lg:text-[48px] leading-[1.25] lg:leading-[62px] tracking-[-1.12px] text-[#000000] flex items-center w-full max-w-[549px] self-stretch">
                    Create, Assign, and Prioritize in One Place
                  </h2>
                  <p className="font-['Inter',sans-serif] font-medium text-[15.6px] leading-[24px] text-[#111827] flex items-center w-full max-w-[549px] self-stretch">
                    Set due dates, priority, and status on every task, with comments and attachments attached directly — no switching tools to find context.
                  </p>
                </div>
            ...
            <ul className="flex flex-col items-start p-0 gap-3 w-full max-w-[549px] self-stretch">
              {[
                "Set due dates, priority levels, and status on every assigned task",
                "Keep comments and file attachments attached directly to the task",
                "Eliminate tool switching for team members looking for work context",
              ].map((text, idx) => (
          ...
          <div className="w-full max-w-[611px] h-auto min-h-[260px] sm:min-h-[380px] lg:h-[496px] rounded-[16px] overflow-hidden border border-slate-200/50 flex items-center justify-center p-3.5 sm:p-6 bg-[radial-gradient(97.14%_126.61%_at_0%_-8.9%,#4F7EFF_0%,#C5E2FF_51.12%,#9AA0FF_100%)] relative">
            <div className="w-full max-w-[503px] bg-white rounded-[14px] border border-[#E5E7EB] p-4 sm:p-6 flex flex-col gap-3.5 sm:gap-4 z-10">
              <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                <span className="font-['Inter',sans-serif] font-bold text-[13px] text-[#111827]">Task Assignment Console</span>
                <span className="bg-[#EFF6FF] text-[#1D4ED8] font-bold text-[10.5px] sm:text-[11px] px-2.5 py-0.5 rounded-full shrink-0">High Priority</span>
              </div>
              <div className="flex flex-col gap-2.5 sm:gap-3">
                <div className="flex items-center justify-between gap-2 p-2.5 sm:p-3 bg-[#F8FAFC] rounded-[10px] border border-[#E5E7EB]">
                  <div className="min-w-0">
                    <div className="font-['Inter',sans-serif] font-semibold text-[12.5px] sm:text-[13px] text-[#111827] truncate">Sprint Release Documentation</div>
                    <div className="font-['Inter',sans-serif] text-[10.5px] sm:text-[11px] text-[#6B7280] truncate">Sarah K. • Due Today</div>
                  </div>
                  <span className="bg-[#EAFBF3] text-[#15803D] font-bold text-[10.5px] sm:text-[11px] px-2.5 py-1 rounded-full shrink-0">Active</span>
                </div>
                <div className="flex items-center justify-between gap-2 p-2.5 sm:p-3 bg-[#F8FAFC] rounded-[10px] border border-[#E5E7EB]">
                  <div className="min-w-0">
                    <div className="font-['Inter',sans-serif] font-semibold text-[12.5px] sm:text-[13px] text-[#111827] truncate">Q3 Security Compliance Audit</div>
                    <div className="font-['Inter',sans-serif] text-[10.5px] sm:text-[11px] text-[#6B7280] truncate">Elena R. • Due Tomorrow</div>
                  </div>
                  <span className="bg-[#EFF6FF] text-[#1D4ED8] font-bold text-[10.5px] sm:text-[11px] px-2.5 py-1 rounded-full shrink-0">In Progress</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Reason 2: Recurring Tasks & Approvals */}
      <section className="w-full py-[60px] px-6 lg:px-[100px]">
          ...
          <div className="flex flex-col items-start p-0 gap-6 mx-auto max-w-[589px] w-full h-auto justify-center self-center">
            <div className="flex flex-col items-start p-0 gap-5 w-full max-w-[549px] self-stretch">
              ...
              <div className="flex flex-col items-start p-0 gap-5 w-full max-w-[549px] self-stretch">
                <div className="flex flex-col items-start p-0 gap-3 w-full max-w-[549px] self-stretch">
                  <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[36px] sm:text-[42px] lg:text-[48px] leading-[1.25] lg:leading-[62px] tracking-[-1.12px] text-[#000000] flex items-center w-full max-w-[549px] self-stretch">
                    Recurring Tasks and Approval Rules
                  </h2>
                  <p className="font-['Inter',sans-serif] font-medium text-[15.6px] leading-[24px] text-[#111827] flex items-center w-full max-w-[549px] self-stretch">
                    Set up recurring tasks for repeatable work, and define approval rules for task completion where sign-off is required.
                  </p>
                </div>
            ...
            <ul className="flex flex-col items-start p-0 gap-3 w-full max-w-[549px] self-stretch">
              {[
                "Automate recurring task schedules for repeatable team workflows",
                "Define manager approval rules before task completion is finalized",
                "Ensure quality sign-off on critical project deliverables",
              ].map((text, idx) => (
                <li key={idx} className="flex flex-row items-center p-0 gap-[12px] w-full">
                  <span className="w-[22px] h-[22px] rounded-[6px] bg-[rgba(16,185,129,0.12)] text-[#10B981] flex flex-row items-center justify-center text-[12px] font-bold shrink-0 border border-[#10B981]/20">
                    ✓
          ...
          <div className="w-full max-w-[611px] h-auto min-h-[260px] sm:min-h-[380px] lg:h-[496px] rounded-[16px] overflow-hidden border border-slate-200/50 flex items-center justify-center p-3.5 sm:p-6 bg-[radial-gradient(97.14%_126.61%_at_0%_-8.9%,#4F7EFF_0%,#C5E2FF_51.12%,#9AA0FF_100%)] relative">
            <div className="w-full max-w-[510px] bg-white/90 backdrop-blur-md rounded-[20px] border border-[#E5E7EB] p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-center gap-5 z-10">
              <div className="w-full sm:w-[210px] bg-white rounded-[16px] border border-[#E5E7EB] p-4 flex flex-col gap-2.5">
                <span className="font-['Inter',sans-serif] font-bold text-[11px] uppercase tracking-wider text-[#6B7280]">APPROVAL RULES</span>
                <div className="flex items-center justify-between bg-[#F8FAFC] border border-[#E5E7EB] rounded-[9px] px-3 py-2 text-[12px]">
                  <span className="font-semibold text-[#111827]">Recurring</span>
                  <span className="font-semibold text-[#5C5CFF]">Weekly</span>
                </div>
                <div className="flex items-center justify-between bg-[#F8FAFC] border border-[#E5E7EB] rounded-[9px] px-3 py-2 text-[12px]">
                  <span className="font-semibold text-[#111827]">Sign-Off</span>
                  <span className="font-semibold text-[#15803D] flex items-center gap-1">Required ✓</span>
                </div>
                <div className="flex items-center justify-between bg-[#F8FAFC] border border-[#E5E7EB] rounded-[9px] px-3 py-2 text-[12px]">
      ...
      {/* Reason 3: Overdue & At-Risk Tasks */}
      <section className="w-full py-[60px] px-6 lg:px-[100px]">
        <div className="w-full max-w-[1240px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-[50px]">
          <div className="flex flex-col items-start p-0 gap-6 mx-auto max-w-[589px] w-full h-auto justify-center self-center">
            <div className="flex flex-col items-start p-0 gap-5 w-full max-w-[549px] self-stretch">
              ...
              <div className="flex flex-col items-start p-0 gap-5 w-full max-w-[549px] self-stretch">
                <div className="flex flex-col items-start p-0 gap-3 w-full max-w-[549px] self-stretch">
                  ...
                  <p className="font-['Inter',sans-serif] font-medium text-[15.6px] leading-[24px] text-[#111827] flex items-center w-full max-w-[549px] self-stretch">
                    Managers see overdue tasks and workload without chasing status updates manually.
                  </p>
                </div>
            ...
            <ul className="flex flex-col items-start p-0 gap-3 w-full max-w-[549px] self-stretch">
              {[
                "Automatic flagging for overdue tasks and at-risk project deadlines",
                "Complete workload visibility without manual status chasing",
                "Proactive risk management before project delivery is impacted",
              ].map((text, idx) => (
                <li key={idx} className="flex flex-row items-center p-0 gap-[12px] w-full">
                  <span className="w-[22px] h-[22px] rounded-[6px] bg-[rgba(16,185,129,0.12)] text-[#10B981] flex flex-row items-center justify-center text-[12px] font-bold shrink-0 border border-[#10B981]/20">
                    ✓
          ...
          <div className="w-full max-w-[611px] h-auto min-h-[260px] sm:min-h-[380px] lg:h-[496px] rounded-[16px] overflow-hidden border border-slate-200/50 flex items-center justify-center p-3.5 sm:p-6 bg-[radial-gradient(97.14%_126.61%_at_0%_-8.9%,#4F7EFF_0%,#C5E2FF_51.12%,#9AA0FF_100%)] relative">
            <div className="w-full max-w-[503px] bg-white rounded-[14px] border border-[#E5E7EB] p-4 sm:p-6 flex flex-col gap-3.5 sm:gap-4 z-10">
              <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                <span className="font-['Inter',sans-serif] font-bold text-[13px] text-[#111827]">Risk Flagging Console</span>
                <span className="bg-[#EAFBF3] text-[#15803D] font-bold text-[10.5px] sm:text-[11px] px-2.5 py-0.5 rounded-full shrink-0">0 Overdue Risk</span>
              </div>
              <div className="flex flex-col gap-2.5 sm:gap-3">
                <div className="flex items-center justify-between gap-2 p-2.5 sm:p-3 bg-[#F8FAFC] rounded-[10px] border border-[#E5E7EB]">
                  <div className="min-w-0">
                    <div className="font-['Inter',sans-serif] font-semibold text-[12.5px] sm:text-[13px] text-[#111827] truncate">API Release Audit</div>
                    <div className="font-['Inter',sans-serif] text-[10.5px] sm:text-[11px] text-[#6B7280] truncate">On Schedule • No Bottlenecks</div>
                  </div>
                  <span className="bg-[#EAFBF3] text-[#15803D] font-bold text-[10.5px] sm:text-[11px] px-2.5 py-1 rounded-full shrink-0">On Track ✓</span>
                </div>
                <div className="flex items-center justify-between gap-2 p-2.5 sm:p-3 bg-[#F8FAFC] rounded-[10px] border border-[#E5E7EB]">
                  <div className="min-w-0">
                    <div className="font-['Inter',sans-serif] font-semibold text-[12.5px] sm:text-[13px] text-[#111827] truncate">Client Portal Sign-Off</div>
                    <div className="font-['Inter',sans-serif] text-[10.5px] sm:text-[11px] text-[#6B7280] truncate">Assignee Available</div>
                  </div>
                  <span className="bg-[#EAFBF3] text-[#15803D] font-bold text-[10.5px] sm:text-[11px] px-2.5 py-1 rounded-full shrink-0">Active</span>
                </div>
              </div>
            ...
            <div className="w-full max-w-[503px] bg-white rounded-[14px] border border-[#E5E7EB] p-3.5 sm:p-6 flex flex-col gap-3 sm:gap-4 z-10 shadow-xs">
              <div className="w-full flex flex-col pt-1">
                <div className="grid grid-cols-[1.2fr_auto_auto] sm:grid-cols-4 pb-2.5 border-b border-gray-100 font-['Inter',sans-serif] font-bold text-[9.5px] sm:text-[10px] uppercase tracking-wider text-[#6B7280] gap-1.5 sm:gap-2 items-center">
                  ...
                  <span className="hidden sm:block truncate">DEADLINE</span>
                  <span className="text-center sm:text-left truncate">STATUS</span>
                  <span className="text-right truncate">AVAILABILITY</span>
                </div>
                ...
                <div className="grid grid-cols-[1.2fr_auto_auto] sm:grid-cols-4 items-center py-2.5 sm:py-3 border-b border-gray-100 text-[11.5px] sm:text-[12.5px] gap-1.5 sm:gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-[10px] text-[#6B7280] block sm:hidden truncate font-medium">Due Today</span>
                    </div>
                  </div>
                  <span className="text-[#111827] font-medium hidden sm:block truncate">Due Today</span>
                  ...
                  <span className="text-right text-[#111827] font-medium shrink-0 text-[11px] sm:text-[12.5px]">Checked In</span>
                </div>

                <div className="grid grid-cols-[1.2fr_auto_auto] sm:grid-cols-4 items-center py-2.5 sm:py-3 border-b border-gray-100 text-[11.5px] sm:text-[12.5px] gap-1.5 sm:gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#F59E0B] text-white font-bold text-[9px] sm:text-[10px] flex items-center justify-center shrink-0">DM</span>
                    <div className="min-w-0">
                      <span className="font-semibold text-[#111827] block truncate">David M.</span>
                      <span className="text-[10px] text-[#6B7280] block sm:hidden truncate font-medium">Due Next Tue</span>
                    </div>
                  </div>
                  <span className="text-[#111827] font-medium hidden sm:block truncate">Due Next Tue</span>
                  <div className="shrink-0 flex justify-center sm:justify-start">
                ...
                <div className="grid grid-cols-[1.2fr_auto_auto] sm:grid-cols-4 items-center py-2.5 sm:py-3 text-[11.5px] sm:text-[12.5px] gap-1.5 sm:gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-[10px] text-[#6B7280] block sm:hidden truncate font-medium">Due Tomorrow</span>
                    </div>
                  </div>
                  <span className="text-[#111827] font-medium hidden sm:block truncate">Due Tomorrow</span>
                  <div className="shrink-0 flex justify-center sm:justify-start">
                    <span className="bg-[#EAFBF3] text-[#15803D] font-bold text-[10px] sm:text-[11px] px-2 sm:px-2.5 py-0.5 rounded-full inline-block shrink-0 whitespace-nowrap">Active</span>
                  </div>
                  <span className="text-right text-[#111827] font-medium shrink-0 text-[11px] sm:text-[12.5px]">Checked In</span>
...
const ProjectManagementManagerVisibilityDark: React.FC = () => (
    ...
    <div className="w-full max-w-[1240px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-[40px] lg:gap-[50px]">
      <div className="flex flex-col items-start max-w-[549px] w-full gap-[20px] sm:gap-[24px]">
        ...
        <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[28px] sm:text-[36px] lg:text-[42px] leading-[1.2] tracking-[-0.84px] text-white">
          See Workload and Availability Together, Not in Separate Tabs
        </h2>
      ...
      <div className="w-full lg:w-[578px] bg-slate-900 border border-slate-800 rounded-[20px] sm:rounded-[24px] p-4 sm:p-6 shadow-2xl flex flex-col gap-3.5 sm:gap-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-800">
          <div className="flex items-center gap-2 min-w-0">
            <span className="w-2.5 h-2.5 rounded-full bg-[#5C5CFF] animate-pulse shrink-0" />
            <span className="font-bold text-[11px] sm:text-xs uppercase tracking-wider text-slate-300 truncate">Project Workload Dashboard</span>
          </div>
          <span className="text-[10px] sm:text-xs text-slate-400 bg-slate-800 px-2 sm:px-2.5 py-1 rounded-md shrink-0">Live Sync</span>
        </div>

        <div className="grid grid-cols-2 gap-2.5 sm:gap-3">
          <div className="bg-slate-800/60 rounded-xl p-3 sm:p-3.5 border border-slate-700/50">
            <div className="text-[11px] sm:text-xs text-slate-400 truncate">Total Active Tasks</div>
            <div className="text-xl sm:text-2xl font-black text-white pt-1">24 Active</div>
            <div className="text-[9.5px] sm:text-[10px] text-emerald-400 pt-0.5 truncate">8 High Priority</div>
          </div>
          <div className="bg-slate-800/60 rounded-xl p-3 sm:p-3.5 border border-slate-700/50">
            <div className="text-[11px] sm:text-xs text-slate-400 truncate">Team Availability</div>
            <div className="text-xl sm:text-2xl font-black text-white pt-1">18 Available</div>
            <div className="text-[9.5px] sm:text-[10px] text-amber-400 pt-0.5 truncate">2 on PTO</div>
          </div>
        </div>

        <div className="bg-slate-800/40 rounded-xl p-3.5 sm:p-4 border border-slate-700/40 flex flex-col gap-2 sm:gap-2.5">
          <div className="text-xs font-bold text-slate-300">Workload Risk Check</div>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-[11.5px] sm:text-xs bg-emerald-950/40 border border-emerald-800/40 p-2.5 rounded-lg text-emerald-200">
            <span className="leading-snug">All active tasks assigned to checked-in team members</span>
            <span className="bg-emerald-800/60 text-emerald-100 px-2 py-0.5 rounded text-[10px] font-bold self-start sm:self-auto shrink-0">100% Balanced</span>
          </div>
        </div>
      </div>
    </div>
...
/* ─── 5. ROADMAP SECTION (CLEARLY LABELED AS UPCOMING) ─── */
const ProjectManagementRoadmap: React.FC = () => (
  <section className="w-full bg-[#F8FAFC] py-[80px] px-6 lg:px-[32px]">
    <div className="w-full max-w-[1240px] mx-auto flex flex-col items-center gap-[40px] text-center">
      <div className="flex flex-col items-center gap-3 max-w-[750px]">
        <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-amber-50 border border-amber-200/80 text-amber-800 font-bold text-[12px] uppercase tracking-wider rounded-full">
        ...
        <h2 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[32px] sm:text-[42px] leading-[1.2] text-[#111827]">
          Built to Grow Into Deeper Project Management
        </h2>
        <p className="font-['Inter',sans-serif] text-[16px] text-[#6B7280]">
          Task management in Workzi today covers assignment, tracking, and approvals. The roadmap adds more for teams running full projects, not just task lists:
        </p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 w-full max-w-[1100px] text-left">
        {[
          { title: 'Kanban & Gantt Views', desc: 'Drag-and-drop task boards and visual project timelines' },
          { title: 'Project Milestones', desc: 'Track major release phases, delivery gates & milestones' },
          { title: 'Team Workload Balancing', desc: 'Smart capacity planning & automated workload optimization' },
          { title: 'Time Tracking & Timesheets', desc: 'Detailed project time logs & billable hour tracking' },
          { title: 'Cross-Functional Projects', desc: 'Multi-department project coordination & team boards' },
          { title: 'Jira, Asana, Slack & Teams', desc: 'Deep third-party integrations for seamless workflow sync' },
        ].map((item, idx) => (
          <div key={idx} className="bg-white border border-[#E5E7EB] rounded-2xl p-6 flex flex-col gap-2 relative overflow-hidden shadow-xs">
            <div className="flex items-center justify-between">
              <span className="font-bold text-[16px] text-[#111827]">{item.title}</span>
              <span className="text-[10px] font-bold text-amber-700 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-200/60">Roadmap</span>
            </div>
            <p className="font-['Inter',sans-serif] text-[13.5px] leading-[20px] text-[#6B7280]">{item.desc}</p>
          </div>
        ))}
      </div>
    </div>
...
const ProjectManagementIntegrations: React.FC = () => (
  <section className="w-full bg-white py-[80px] px-6 lg:px-[32px]">
    <div className="w-full max-w-[1240px] mx-auto flex flex-col items-center gap-[40px] text-center">
      <div className="flex flex-col items-center gap-3 max-w-[700px]">
        ...
        <p className="font-['Inter',sans-serif] text-[16px] text-[#6B7280]">
          Task tracking that connects to the calendar, communication, and productivity tools your team relies on.
        </p>
      </div>
...
/* ─── 7. FAQ SECTION ─── */
const ProjectManagementFAQ: React.FC = () => {
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  const faqs = [
    {
      q: 'Can I assign tasks with due dates and priority levels?',
      a: 'Yes. Every task can have a due date, priority, status, comments, and attachments.',
    },
    {
      q: 'Does Workzi support recurring tasks?',
      a: 'Yes. Set up recurring tasks for work that repeats on a schedule.',
    },
    {
      q: 'Can managers see overdue or at-risk tasks automatically?',
      a: 'Yes. Overdue tasks are flagged so managers don\'t have to manually track status across the team.',
    },
    {
      q: 'Does Workzi have Kanban or Gantt chart views?',
      a: 'Not yet — these are on our active product roadmap. Today, tasks are tracked by status, priority, and due date.',
    },
    {
      q: 'Does Workzi integrate with Jira, Asana, Slack, or Microsoft Teams?',
      a: 'These integrations are planned for a future roadmap release to expand our ecosystem.',
    },
    {
      q: 'Can task completion require manager approval?',
      a: 'Yes, where configured — approval rules can be set for task completion.',
    },
  ];
      ...
      <div className="w-full max-w-[850px] mx-auto flex flex-col items-center gap-[48px]">
        ...
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <p className="font-['Inter',sans-serif] font-normal text-[16px] sm:text-[17px] leading-[26px] text-[#6B7280]">
            Everything teams ask about Workzi Project & Task Management software.
          </p>
        </div>
...
const ProjectManagementRoleCTABanner: React.FC = () => (
    ...
    <div className="w-full max-w-[1184px] mx-auto bg-[linear-gradient(98.16deg,#8B8DFF_0%,#6366F1_50%,#818CF8_100%)] rounded-[32px] py-[72px] px-6 lg:px-[80px] flex flex-col items-center text-center relative overflow-hidden">
      ...
      <div className="w-full max-w-[848px] mx-auto flex flex-col items-center gap-[15px] relative z-10">
        ...
        <h3 className="font-['Plus_Jakarta_Sans',sans-serif] font-semibold text-[18px] sm:text-[22px] leading-[32px] tracking-[-0.64px] text-[#CACDFF] max-w-[650px] mx-auto">
          One platform for what needs doing, who's doing it, and whether they're actually available to do it.
        </h3>
...
/* ─── MAIN PROJECT MANAGEMENT SOLUTIONS PAGE COMPONENT ─── */
export const ProjectManagementPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <ProjectManagementProblemValue />
      <ProjectManagementKnowledgeSections />
      <ProjectManagementManagerVisibilityDark />
      <ProjectManagementRoadmap />
      <ProjectManagementIntegrations />
      <ProjectManagementFAQ />
      <ProjectManagementRoleCTABanner />
    </div>
  );
};
