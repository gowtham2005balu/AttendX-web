...
import { Factory, Users, CheckCircle2, ShieldCheck, MapPin, Cpu } from 'lucide-react';

export const ManufacturingHeroChart: React.FC = () => {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 z-10">
        ...
        >
          <div className="flex items-center justify-between text-slate-500 text-[11px] font-semibold">
            <span>Plant Attendance</span>
            <Factory size={14} className="text-[#5C5CFF] shrink-0" />
          </div>
          <div className="flex items-baseline justify-between pt-0.5 gap-1">
            <span className="text-[18px] sm:text-[20px] font-black text-slate-900">142 / 145</span>
            <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded shrink-0">97.9%</span>
          </div>
        </motion.div>
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-[18px] border border-slate-200/70 p-3.5 flex flex-col justify-between shadow-xs">
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 gap-2">
            <span className="text-[12px] font-bold text-slate-800 flex items-center gap-1.5 shrink-0">
              <Factory size={13} className="text-[#5C5CFF]" />
              Plant Coverage
            </span>
            <span className="text-[10px] font-semibold text-slate-400 shrink-0">Shift Roster</span>
          </div>
          ...
          <div className="flex flex-col gap-2 pt-1.5">
            ...
            <div className="flex items-center justify-between p-2 rounded-xl bg-indigo-50/70 border border-indigo-100 gap-2">
              <div className="min-w-0">
                <div className="text-[11.5px] font-bold text-indigo-950 truncate">Plant Alpha (Main)</div>
                <div className="text-[10px] text-indigo-600 font-medium truncate">Morning Shift • 58 Workers</div>
              </div>
              <span className="bg-[#5C5CFF] text-white text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0">100% Logged</span>
            </div>

            {/* Plant 2 */}
            <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 border border-slate-200/50 gap-2">
              <div className="min-w-0">
                <div className="text-[11.5px] font-bold text-slate-900 truncate">Plant Beta (Auto)</div>
                <div className="text-[10px] text-slate-500 font-medium truncate">Assembly Shift A</div>
              </div>
              <span className="bg-emerald-100 text-emerald-800 text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0">44/45 Logged</span>
            </div>

            {/* Plant 3 */}
            <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 border border-slate-200/50 gap-2">
              <div className="min-w-0">
                <div className="text-[11.5px] font-bold text-slate-900 truncate">Site Gamma (Energy)</div>
                <div className="text-[10px] text-slate-500 font-medium truncate">Grid Maintenance</div>
              </div>
              <span className="bg-emerald-100 text-emerald-800 text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0">40/42 Logged</span>
            </div>
          </div>
        </div>

        {/* Right Column: Live Floor Log */}
        <div className="bg-white/90 backdrop-blur-md rounded-[18px] border border-slate-200/70 p-3.5 flex flex-col justify-between shadow-xs">
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 gap-2">
            <span className="text-[12px] font-bold text-slate-800 flex items-center gap-1.5 shrink-0">
            ...
            <div className="flex items-center justify-between text-[11px] gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[9.5px] text-slate-400 truncate">Plant Lead • QR Station</div>
                </div>
              </div>
              <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded shrink-0">07:55 AM</span>
            </div>
            ...
            <div className="flex items-center justify-between text-[11px] gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[9.5px] text-slate-400 truncate">Assembly • Kiosk Check-in</div>
                </div>
              </div>
              <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded shrink-0">08:00 AM</span>
            </div>
            ...
            <div className="flex items-center justify-between text-[11px] gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[9.5px] text-slate-400 truncate">Safety Insp. • Geo Log</div>
                </div>
              </div>
              <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded shrink-0">Verified</span>
            </div>
          </div>
        </div>
      </div>
...
export default ManufacturingHeroChart;
