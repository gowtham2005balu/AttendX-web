  ...
  <section className="relative flex flex-col items-center justify-start bg-white pt-[90px] min-h-[640px] lg:min-h-[855px] pb-16 lg:pb-[220px] overflow-visible z-20 isolate">
    ...
    <Container className="relative z-20 text-center flex flex-col items-center max-w-[1440px] px-4">
      <FadeUp className="flex flex-col items-center w-full max-w-[1440px]">
        ...
        {/* button.hero-btn */}
        <a href="/contact-support" className="bg-white hover:bg-slate-50 text-[#1A1A1A] font-['Inter',sans-serif] font-semibold text-[15px] leading-[18px] px-[32px] py-[14px] rounded-[50px] shadow-[0_4px_16px_rgba(0,0,0,0.15)] transition-all duration-300 hover:scale-[1.03] cursor-pointer inline-flex items-center justify-center">
          Book Demo
        </a>
    ...
    <div className="relative mt-8 lg:mt-0 lg:absolute lg:bottom-0 lg:left-1/2 lg:-translate-x-1/2 lg:translate-y-[25%] w-full max-w-[800px] px-4 z-30 animate-in fade-in slide-in-from-bottom-8 duration-700">
      
      {/* Floating Left Tag */}
      <div className="absolute -left-[5%] sm:-left-[60px] top-[40px] bg-white rounded-xl shadow-lg border border-gray-100 p-3.5 pr-6 flex items-center gap-3 z-40 animate-bounce" style={{ animationDuration: '3s' }}>
        ...
        <div className="flex flex-col text-left">
          ...
          <span className="font-medium text-[12px] text-gray-500 leading-tight whitespace-nowrap">Present Students</span>
        </div>
      </div>

      {/* Floating Right Tag */}
      <div className="absolute -right-[5%] sm:-right-[60px] bottom-[60px] bg-white rounded-xl shadow-lg border border-gray-100 p-3.5 pr-6 flex items-center gap-3 z-40 animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
        ...
        <div className="flex flex-col text-left">
          ...
          <span className="font-medium text-[12px] text-gray-500 leading-tight whitespace-nowrap">Faculty Available</span>
        </div>
      </div>

      {/* Main Card */}
      <div className="bg-white/95 backdrop-blur-xl rounded-[24px] shadow-[0_30px_60px_rgba(17,24,39,0.18)] border border-white/20 p-6 sm:p-8 relative z-30 w-full overflow-hidden text-left">
        {/* Header */}
  ...
  <section id={id} className={`py-[60px] px-4 md:px-12 lg:px-[100px] ${bg} relative overflow-hidden scroll-mt-24 max-w-[1440px] mx-auto`}>
    <Container className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-start justify-between gap-12 lg:gap-[60px] max-w-[1240px] mx-auto`}>
      ...
      <FadeUp delay={0.2} className="flex-1 max-w-[549px] flex flex-col items-start">
        ...
        {/* Button */}
        <div>
          <a href={href} className="inline-flex items-center justify-center gap-2 bg-black hover:bg-[#1A1A1A] text-white font-['Inter',sans-serif] text-[14px] font-semibold leading-[17px] px-[26px] py-[13px] rounded-[50px] transition-all duration-300 shadow-md cursor-pointer">
            {cta}
            <ArrowRight size={14} />
          </a>
        </div>
...
const SolutionsPage: React.FC = () => (
  <div id="solutions-page" className="relative overflow-x-hidden bg-white">
    ...
    <FeatureItem
      ...
      href="#" // Flagged destination - need user input/flag
      bullets={[
        'Book Catalog',
        'Issue & Return',
        'Library Analytics',
