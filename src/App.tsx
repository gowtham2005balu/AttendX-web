...
import WhyWorkziPage from './components/WhyAttendX/WhyWorkziPage';
import WorkziVsManualHRPage from './components/WhyAttendX/WorkziVsManualHRPage';
import WorkziVsTraditionalHRMSPage from './components/WhyAttendX/AttendXVsTraditionalHRMSPage';
...
import ScaleWithWorkziPage from './components/WhyAttendX/ScaleWithWorkziPage';
...
const getBaseView = (pathOrHash: string): string => {
  ...
  if (clean === 'why-workzi') return 'why-attendx';
  if (clean === 'workzi-vs-manual-hr') return 'attendx-vs-manual-hr';
  if (clean === 'workzi-vs-traditional-hrms') return 'attendx-vs-traditional-hrms';
  if (clean === 'for-enterprise') return 'for-enterprise';
  if (clean === 'for-small-business') return 'for-small-business';
  if (clean === 'scale-with-workzi') return 'scale-with-attendx';
  if (clean === 'trust-and-security') return 'trust-and-security';
  if (clean === 'features') return 'features';
  if (clean === 'features/attendance-management' || clean.startsWith('feat-')) return 'attendance-management';
  if (clean === 'features/time-off-management' || clean === 'simplify-time-off' || clean === 'simplify-leave') return 'time-off-management';
  if (clean === 'features/shift-management') return 'shift-management';
  if (clean === 'features/task-management') return 'task-management';
  if (clean === 'features/employee-self-service') return 'employee-self-service';
  if (clean === 'features/organization-management') return 'organization-management';
  if (clean === 'features/ai-assistant') return 'ai-assistant';
  if (clean === 'features/security-access-control') return 'security-access-control';
  if (clean === 'features/mobile-experience') return 'mobile-experience';
  if (clean === 'features/integrations' || clean === 'integrations-feature' || clean === 'hrms-integrations') return 'integrations';
  // Solutions
  if (clean === 'solutions') return 'solutions';
  if (clean === 'solutions/hr' || clean === 'human-resources') return 'hr-solutions';
  if (clean === 'solutions/customer-service' || clean === 'customer-service') return 'customer-service-solutions';
  if (clean === 'solutions/engineering' || clean === 'engineering') return 'engineering-solutions';
  if (clean === 'solutions/it' || clean === 'it') return 'it-solutions';
  if (clean === 'solutions/sales' || clean === 'sales') return 'sales-solutions';
  if (clean === 'solutions/project-management' || clean === 'project-management') return 'project-management-solutions';
  if (clean === 'solutions/marketing' || clean === 'marketing') return 'marketing-solutions';
  if (clean === 'solutions/manufacturing-auto-energy' || clean === 'manufacturing') return 'manufacturing-auto-energy-solutions';
  if (clean === 'solutions/technology' || clean === 'technology') return 'technology-solutions';
  if (clean === 'solutions/media' || clean === 'media') return 'media-solutions';
  if (clean === 'solutions/small-business' || clean === 'small-business') return 'small-business-solutions';
  if (clean === 'solutions/financial-services' || clean === 'financial-services') return 'financial-services-solutions';
  if (clean === 'solutions/retail' || clean === 'retail') return 'retail-solutions';
  if (clean === 'solutions/healthcare' || clean === 'health-life-sciences' || clean === 'healthcare') return 'healthcare-solutions';
  if (clean === 'solutions/education' || clean === 'education-industry' || clean === 'education') return 'education-solutions';
...
function App() {
  ...
  const isWorkziVsTraditionalHRMSView = currentView === 'attendx-vs-traditional-hrms';
  const isForEnterpriseView = currentView === 'for-enterprise';
  const isForSmallBusinessView = currentView === 'for-small-business';
  const isScaleWithWorkziView = currentView === 'scale-with-attendx';
  ...
  return (
    <div className="relative overflow-x-clip min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        ) : isWorkziVsManualHRView ? (
          <>
            <WorkziVsManualHRPage />
            <Footer />
          </>
        ) : isWorkziVsTraditionalHRMSView ? (
          <>
            <WorkziVsTraditionalHRMSPage />
            <Footer />
          </>
        ) : isForEnterpriseView ? (
          <>
