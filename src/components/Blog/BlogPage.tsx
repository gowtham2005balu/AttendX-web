        ...
        <Container className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {displayedStories.map((story, idx) => (
              <FadeUp key={idx} delay={(idx % 6) * 0.08} className="h-full">
                <a href="/blog-article" className="bg-white border border-slate-200 rounded-3xl overflow-hidden hover:shadow-xl hover:border-slate-300 transition-all group flex flex-col h-full block">
                  {/* Card Header Graphic */}
