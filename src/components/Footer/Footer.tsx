...
export const Footer: React.FC = () => {
  ...
  useEffect(() => {
    const update = () => setCurrentPath(getCurrentPath());
  ...
  const featureLinks = [
    ...
    { label: 'Time-off Management', href: '/features/time-off-management' },
    ...
    { label: 'Organization Management', href: '/features/organization-management' },
    { label: 'AI Assistant', href: '/features/ai-assistant' },
    { label: 'Security & Access Control', href: '/features/security-access-control' },
    { label: 'Mobile Experience', href: '/features/mobile-experience' },
  ...
  const whyWorkziLinks = [
    { label: 'Why Workzi', href: '/why-workzi' },
    { label: 'Workzi vs Manual HR', href: '/workzi-vs-manual-hr' },
    { label: 'Workzi vs Traditional HRMS', href: '/workzi-vs-traditional-hrms' },
  ...
  const getLinkCls = (href: string) => {
    ...
    return `font-['Plus_Jakarta_Sans',sans-serif] font-normal text-[13px] sm:text-[14px] leading-[20px] transition-colors duration-200 block ${isActive
      ...
      <div className="max-w-[1280px] mx-auto w-full">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-[48px] pb-12">
          ...
          <div className="w-full lg:w-[242px] flex flex-col items-start shrink-0 gap-4 pr-0 lg:pr-8">
            {/* Logo */}
            <a href="/" onClick={scrollToTop} className="flex items-center gap-[10px] group h-[36px]">
            ...
            <div className="flex items-center gap-2.5 pt-2">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-[9px] bg-white/[0.06] border border-white/[0.08] text-white/60 flex items-center justify-center transition-all duration-200 hover:text-white hover:bg-white/[0.12] shrink-0"
