...
const getBaseView = (pathOrHash: string): string => {
  ...
  // Features sub-pages — support both /features/xxx and legacy /xxx flat paths
  if (clean === 'features/attendance-management' || clean === 'attendance-management' || clean === 'track-attendance' || clean.startsWith('feat-')) return 'attendance-management';
  if (clean === 'features/time-off-management' || clean === 'time-off-management' || clean === 'leave-management' || clean === 'simplify-time-off' || clean === 'simplify-leave') return 'time-off-management';
  if (clean === 'features/shift-management' || clean === 'shift-management') return 'shift-management';
  if (clean === 'features/task-management' || clean === 'task-management') return 'task-management';
  if (clean === 'features/employee-self-service' || clean === 'employee-self-service') return 'employee-self-service';
  if (clean === 'features/organization-management' || clean === 'organization-management') return 'organization-management';
  if (clean === 'features/ai-assistant' || clean === 'ai-assistant') return 'ai-assistant';
  if (clean === 'features/security-access-control' || clean === 'security-access-control') return 'security-access-control';
  if (clean === 'features/mobile-experience' || clean === 'mobile-experience') return 'mobile-experience';
  if (clean === 'features/integrations' || clean === 'integrations' || clean === 'integrations-feature' || clean === 'hrms-integrations') return 'integrations';
  // Solutions — support both /solutions/xxx and legacy /xxx flat paths
  if (clean === 'solutions') return 'solutions';
  if (clean === 'solutions/hr-solutions' || clean === 'hr-solutions' || clean === 'human-resources') return 'hr-solutions';
  if (clean === 'solutions/customer-service-solutions' || clean === 'customer-service-solutions' || clean === 'customer-service') return 'customer-service-solutions';
  if (clean === 'solutions/engineering-solutions' || clean === 'engineering-solutions' || clean === 'engineering') return 'engineering-solutions';
  if (clean === 'solutions/it-solutions' || clean === 'it-solutions' || clean === 'it') return 'it-solutions';
  if (clean === 'solutions/sales-solutions' || clean === 'sales-solutions' || clean === 'sales') return 'sales-solutions';
  if (clean === 'solutions/project-management-solutions' || clean === 'project-management-solutions' || clean === 'project-management') return 'project-management-solutions';
  if (clean === 'solutions/marketing-solutions' || clean === 'marketing-solutions' || clean === 'marketing') return 'marketing-solutions';
  if (clean === 'solutions/manufacturing-auto-energy-solutions' || clean === 'manufacturing-auto-energy-solutions' || clean === 'manufacturing-auto-energy' || clean === 'manufacturing') return 'manufacturing-auto-energy-solutions';
  if (clean === 'solutions/technology-solutions' || clean === 'technology-solutions' || clean === 'technology') return 'technology-solutions';
  if (clean === 'solutions/media-solutions' || clean === 'media-solutions' || clean === 'media') return 'media-solutions';
  if (clean === 'solutions/small-business-solutions' || clean === 'small-business-solutions' || clean === 'small-business') return 'small-business-solutions';
  if (clean === 'solutions/financial-services-solutions' || clean === 'financial-services-solutions' || clean === 'financial-services') return 'financial-services-solutions';
  if (clean === 'solutions/retail-solutions' || clean === 'retail-solutions' || clean === 'retail') return 'retail-solutions';
  if (clean === 'solutions/healthcare-solutions' || clean === 'healthcare-solutions' || clean === 'health-life-sciences-solutions' || clean === 'health-life-sciences' || clean === 'healthcare') return 'healthcare-solutions';
  if (clean === 'solutions/education-solutions' || clean === 'education-solutions' || clean === 'education-solutions-page' || clean === 'education-industry' || clean === 'education') return 'education-solutions';
